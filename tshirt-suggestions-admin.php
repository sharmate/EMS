...
<head>
    ...
    <title>T-Shirt Suggestions | EMS</title>
	<!-- Font Aswsome -->
...
<body>
    ...
    <div id="wrapper" class="Background-side-bar">
        ...
        <div id="page-wrapper" style="margin-top: -23px;">
                ...
                <h1 class="header-top employee-list-header t_shirt_admin_header"><i class="fa fa-users"></i>&nbsp;&nbsp;T-Shirt Suggestions</h1>
				<hr/>
...
<script type="text/javascript" language="javascript" >
 $(document).ready(function(){
  ...
  function fetch_data()
  {
   var dataTable = $('#user_data').DataTable({
    ...
    "order" : [],
    "ajax" : {
     url:"all-tshirt-suggestions.php",
     type:"POST"
    }
   });
  }
 ...
 $(document).on('click', '.delete', function(){
   ...
   {
    $.ajax({
     url:"delete-tshirt-suggestions.php",
     method:"POST",
     data:{id:id},
