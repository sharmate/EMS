...
<head>
    ...
    <title>Attendance Sheet | Add</title>
	<!-- Font Aswsome -->
...
<!--                                 </li> -->
                           ...
                           <?php 
                            ...
                            ?>
                                 <li>
                                <a href="add.php"  class="anchor-btn"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add</a>
                                </li>
                                
                                <li>
                                <a href="view.php"  class="anchor-btn-view"><i class="fa fa-eye"></i>&nbsp;&nbsp;View</a>
                                </li>
