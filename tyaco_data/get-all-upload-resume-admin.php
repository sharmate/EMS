...
//include('session.php');
include 'config.php';
$columns = array('name', 'email', 'contact', 'subject', 'resume', 'data_added');
...
while($row = mysqli_fetch_array($result))
{
    ...
    $sub_array[] = '<div class="update" data-id="'.$row["employee_id"].'" data-column="resume"><a href="http://localhost/tya_ems/tyaco_data/'.$row["resume"].'" title="RESUME" class="tyaco_upload_file_btn"><i class="fa fa-file" aria-hidden="true"></i></a></div>';
