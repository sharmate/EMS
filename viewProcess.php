...
$tmpStr = "select ea.*, employee.name as employee_name from employee_attendance as ea, employee where ea.month='".$tmpMonth."' AND ea.year='".$tmpYear."' AND ea.userid='".$tmpUserId."' AND employee.employee_id = ea.userid";
...
if(empty($tmpResult))
{
    $output = array();
    $output['status'] = false;
    $output['message'] = "Employee Attendance Not found.";
...
$output['message'] = "Attendance View Successfully.";
