...
<body>
                    ...
                    <div class="panel-body">
                        <form role="form" action="" method="post">
                            <fieldset>
                                ...
                                <input type="button" name="Submit" value="Reset Password" class="btn btn-lg btn-success btn-block" onclick='resetPassword()'/>
                            </fieldset>
                        </form>
                    </div>
                </div>
	...
	function resetPassword(){
		//alert('test');
			var id ="<?php echo $_SESSION['login_userid'];?>";
			...
			temObject.id = id;
			temObject.newPassword = newPassword;
			temObject.confirmPassword = confirmPassword;

			var settings = {
					"async": false,
			  		  "crossDomain": true,
			  		  "url": "reset-password-process.php",
			  		  "method": "POST",
			  		  "headers": {
			  		...
			  		$.ajax(settings).done(function (response) {
			  		      ...
			  		      .then((value) =>{
								location.href = "<?php echo 'index.php' ?>";
				  		      });
