...
$sql = "SELECT ea.*, em.name as employee_name, em.email as email_id FROM tshirt_suggestions as ea, employee as em where em.employee_id = ea.employee_id";
...
$objPHPExcel->getActiveSheet()->setTitle('preferred_tshirt_size');

$objPHPExcel->getActiveSheet()->setCellValue('A1', "Employee Name");
$objPHPExcel->getActiveSheet()->setCellValue('B1', "Employee Email");
$objPHPExcel->getActiveSheet()->setCellValue('C1', "Preferred T-Shirt Size");
...
for($i=0; $i<sizeof($tmpData); $i++)
{
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('C'.$no, $tmpEmpData['preferred_tshirt_size']);
...
$filename='Tshirt_'.date("Ymdhis").'.xlsx'; //save our workbook as this file name
