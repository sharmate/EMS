...
<head>
    ...
    <title>Attendance Sheet | List</title>
	<!-- Font Aswsome -->
...
<!--                                 </li> -->
                               ...
                               <li class="active">
                                <a href="employeeList.php" class="anchor-btn"><i class="fa fa-users"></i>&nbsp;&nbsp;Employee List</a>
                               </li>
                           <?php 
                            }
                            ...
                            ?>
<!--                                  <li> -->
<!--                                 <a href="add.php"  class="anchor-btn-add"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add</a> -->
<!--                                 </li> -->
                                
                                <li style="background-color: #fff;">
                                <a href="view.php"  class="anchor-btn"><i class="fa fa-eye"></i>&nbsp;&nbsp;View</a>
                                </li>
                ...
                <div class="row">
                	...
                	<div class="col-md-5">
                		<div class="form-group">
                        	<select class="form-control months" id="filter_month">
                	...
                	<div class="col-md-5">
                		<div class="form-group">
                        	<select class="form-control years" id="filter_year">
                	...
                	<div class="col-md-2">
                		<a href="exportAttendance.php" class="btn btn-success exportAttendance" name="exportAttendance">Export Attendance</a>
                	</div>
...
//                                     array_push($tmpHolidays, $tmpHoliday);
	...
	function viewAttendance()
	{
        ...
        $.ajax(settings).done(function (response) {
         ...
         if(tmpResult.employee_name && tmpResult.employee_name !== "")
         {
        	 employeeName = tmpResult.employee_name;
         }
