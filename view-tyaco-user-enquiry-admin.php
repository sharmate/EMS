...
<head>
    ...
    <title>User Enquiry List | TYACO</title>
	<!-- Font Aswsome -->
...
<body>
    ...
    <div id="wrapper" class="Background-side-bar">
        ...
        <div id="page-wrapper" style="margin-top: -23px;">
                ...
                <h1 class="header-top employee-list-header t_shirt_admin_header"><i class="fa fa-users"></i>&nbsp;&nbsp;User Enquiry List</h1>
				<hr/>
...
<script type="text/javascript" language="javascript" >
 $(document).ready(function(){
  ...
  function fetch_data()
  {
   var dataTable = $('#user_data').DataTable({
    ...
    "order" : [],
    "ajax" : {
     url:"tyaco_data/get-all-user-enguiry-admin.php",
     type:"POST"
    }
   });
  }
 ...
 $(document).on('click', '.delete', function(){
   ...
   {
    $.ajax({
     url:"tyaco_data/delete-user-enquiry.php",
     method:"POST",
     data:{id:id},
